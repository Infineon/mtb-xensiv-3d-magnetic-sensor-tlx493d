...
SEARCH_bt-fw-mur-cyw4343w=../mtb_shared/bt-fw-mur-cyw4343w/release-v1.0.0
...
CY_HELP_config_usbdev=Launches the USB Configurator [for USBDEV middleware] 2.90 GUI for the target's cyusbdev file
CY_HELP_config_usbdev_VERBOSE=Launches the USB Configurator [for USBDEV middleware] 2.90 GUI. Check the USB Configurator [for USBDEV middleware] 2.90 User Guide for more information.
...
CY_HELP_usbdev-configurator=Launches the USB Configurator [for USBDEV middleware] 2.90 GUI for the target's cyusbdev file
CY_HELP_usbdev-configurator_VERBOSE=Launches the USB Configurator [for USBDEV middleware] 2.90 GUI. Check the USB Configurator [for USBDEV middleware] 2.90 User Guide for more information.
