...
* CAPSENSE(TM) Configurator 8.0.0.8913
*
********************************************************************************
...
#define CY_CAPSENSE_LLS_WIDGET_COUNT                                             (0u)
...
#define CY_CAPSENSE_SMARTSENSE_CSD_RESISTANCE_CONST                              (1000u)
#define CY_CAPSENSE_SMARTSENSE_ISX_RESISTANCE_CONST                              (700u)
#define CY_CAPSENSE_SMARTSENSE_EN                                                (CY_CAPSENSE_SMARTSENSE_CSD_EN || CY_CAPSENSE_SMARTSENSE_ISX_EN)
#define CY_CAPSENSE_SMARTSENSE_CSD_EN                                            (CY_CAPSENSE_SMARTSENSE_CSD_ACTIVE_HW_EN || CY_CAPSENSE_SMARTSENSE_CSD_LP_HW_EN)
#define CY_CAPSENSE_SMARTSENSE_ISX_EN                                            (CY_CAPSENSE_SMARTSENSE_ISX_ACTIVE_HW_EN || CY_CAPSENSE_SMARTSENSE_ISX_LP_HW_EN)
#define CY_CAPSENSE_SMARTSENSE_ACTIVE_FULL_EN                                    (CY_CAPSENSE_SMARTSENSE_CSD_ACTIVE_FULL_EN || CY_CAPSENSE_SMARTSENSE_ISX_ACTIVE_FULL_EN)
#define CY_CAPSENSE_SMARTSENSE_ACTIVE_HW_EN                                      (CY_CAPSENSE_SMARTSENSE_CSD_ACTIVE_HW_EN || CY_CAPSENSE_SMARTSENSE_ISX_ACTIVE_HW_EN)
#define CY_CAPSENSE_SMARTSENSE_LP_HW_EN                                          (CY_CAPSENSE_SMARTSENSE_CSD_LP_HW_EN || CY_CAPSENSE_SMARTSENSE_ISX_LP_HW_EN)
#define CY_CAPSENSE_SMARTSENSE_CSD_ACTIVE_FULL_EN                                (1u)
#define CY_CAPSENSE_SMARTSENSE_CSD_ACTIVE_HW_EN                                  (1u)
#define CY_CAPSENSE_SMARTSENSE_CSD_LP_HW_EN                                      (0u)
#define CY_CAPSENSE_SMARTSENSE_ISX_ACTIVE_FULL_EN                                (0u)
#define CY_CAPSENSE_SMARTSENSE_ISX_ACTIVE_HW_EN                                  (0u)
#define CY_CAPSENSE_SMARTSENSE_ISX_LP_HW_EN                                      (0u)
...
#define CY_CAPSENSE_REGULAR_RC_CMF_FILTER_EN                                     (0u)
...
#define CY_CAPSENSE_CSD_LIQUID_LEVEL_EN                                          (0u)
#define CY_CAPSENSE_CSD_LIQUID_LEVEL_FOAM_REJECTION_EN                           (0u)
...
#define CY_CAPSENSE_LIQUID_LEVEL_EN                                              (0u)
#define CY_CAPSENSE_LIQUID_LEVEL_FOAM_REJECTION_EN                               (0u)
